  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.menu}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('South_Indian_N')}
          style={{
            elevation: 10,
            backgroundColor: 'white',
            height: 120,
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Chineese_N')}
          style={{
            elevation: 10,
            backgroundColor: 'white',
            height: 120,
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Specials_N')}
          style={{
            elevation: 10,
            backgroundColor: 'white',
            height: 120,
      ...
      <View style={styles.menu1}>
        <TouchableOpacity
          onPress={() => navigation.navigate('North_Indian_N')}
          style={{
            elevation: 10,
            backgroundColor: 'white',
            height: 120,
